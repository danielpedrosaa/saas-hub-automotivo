...
const AppRoutes = () => (
  <Routes>
    ...
    <Route path="/clientes/crm-retorno" element={<ProtectedRoute><OwnerRoute><CrmRetornoPage /></OwnerRoute></ProtectedRoute>} />
    ...
    <Route path="/estoque" element={<ProtectedRoute><OwnerRoute><EstoquePage /></OwnerRoute></ProtectedRoute>} />
